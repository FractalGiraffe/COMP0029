...
Error bars in Figure 5 represent the 95 \% CI. Error bars in Figure 6 represent the 95 \% CI.
...
\caption{Average precision and recall of global model across clients in comparison to that of local, siloed models}
\end{figure*}
...
\caption{Average dispersion of precision and recall of global model across clients in comparison to that of local, siloed models}
\end{figure*}
